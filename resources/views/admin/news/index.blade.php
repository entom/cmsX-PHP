...
@section('content')
    <div class="col s12">
        <header class="row navigation-row">
            ...
            <div class="col s6">
                <a href="{{ url('/admin/news/create') }}" class="waves-effect waves-light btn right" title="Dodaj nowy wpis"><i class="fa fa-plus"></i></a>
            </div>
        </header>
        <div class="row">
            <div class="col s12 m12 animated flipInX">
                <div class="card">
                    ...
                    <div class="card-content">
                        <table class="responsive-table bordered striped highlight">
                            ...
                            @foreach($news as $item)
                                <tr>
                                    ...
                                    <td>
                                        @if ($item->file != NULL)
                                            <img src="/files/thumb/news/100x100_{{ $item->file }}" class="news-image-small" />
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        <a href="{{ url('/admin/news/' . $item->id) }}" class="waves-effect waves-light btn"
                                           title="Zobacz"><i class="fa fa-folder-open"></i></a>
                                        <a href="{{ url('/admin/news/' . $item->id . '/edit') }}" class="waves-effect waves-light btn"
                        ...
                        @include('admin.partials.form.pagination', ['items' => $news])
