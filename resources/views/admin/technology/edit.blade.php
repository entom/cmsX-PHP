...
@section('content')
    ...
    <div class="col s12">
        ...
        {!! Form::model($technology, ['method' => 'PATCH', 'url' => ['/admin/technology', $technology->id], 'class' => 'col s12', 'files' => true]) !!}
        <div class="row">
            <div class="col s12">
                <ul class="tabs">
            ...
            <div class="form-group {{ $errors->has('subtitle') ? 'has-error' : ''}}">
                {!! Form::label('subtitle', 'Subtitle', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
