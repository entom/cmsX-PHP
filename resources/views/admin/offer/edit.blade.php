...
@section('content')
    ...
    <div class="col s12">
        ...
        {!! Form::model($offer, ['method' => 'PATCH', 'url' => ['/admin/offer', $offer->id], 'class' => 'col s12', 'files' => true]) !!}
        <div class="row">
            <div class="col s12">
                <ul class="tabs">
                    <li class="tab col s3"><a class="active" href="#contentTab">Treść</a></li>
                    <li class="tab col s3"><a class="active" href="#seoTab">SEO</a></li>
                </ul>
            </div>
            <div id="contentTab" class="col s12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="row">
                            <div class="input-field col s12 m12 {{ $errors->has('title') ? 'has-error' : ''}}">
                            ...
                            <div class="input-field col s12 m12 {{ $errors->has('short_content') ? 'has-error' : ''}}">
                                ...
                                {!! Form::label('short_content', 'Krótka treść', ['data-error' => 'wrong', 'data-success' => 'right']) !!}
                                {!! Form::textarea('short_content', null, ['class' => 'editor']) !!}
                            </div>
